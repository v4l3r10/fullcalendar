function ResourceEventRenderer() {
    ...
    function compileSlotSegs(events) {
        var colCnt = getColCnt(),
            ...
            segs = [];
        resources = calendar.getResources();
        var resourceEvents, visEventEndsForRes;
        for (i = 0; i < colCnt; i++) {
    ...
    function draggableSlotEvent(event, eventElement, timeElement) {
        ...
        eventElement.draggable({
            ...
            stop: function (ev, ui) {
				...
				var resources;
                trigger('eventDragStop', eventElement, event, ev, ui);
				//columnDelta todo controllare TODO
                if (isInBounds && (isAllDay || columnDelta || minuteDelta)) { // changed!
					resources = calendar.getResources();
					event.resource = resources[newColumn];
					event.resource._col = newColumn;
